    ...
    public async Task RespondToRequestAsync(ResponseRequestDto dto, int executorId)
{
    ...
    if (request.ExecutorId != executorId)
        throw new Exception("You are not the executor of this request");
    ...
    if (request.Status != RequestStatus.Initial)
        throw new Exception("Request is not in Initial status");
    ...
    if (request.Status != RequestStatus.InProgress)
        throw new Exception("Request is not in InProgress status");
    ...
    if (request.Status != RequestStatus.Completed)
        throw new Exception("Request is not in Completed status");
